...
Tags name is made from join of [simple tags of docker](https://hub.docker.com/_/docker) and [versions of ansible](https://github.com/ansible-community/ansible-build-data/tags).

* `20.10.17-ansible-6.2.0`, `latest`
